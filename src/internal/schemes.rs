...
use aead::Payload;
use blake2::{Blake2b, Digest}; // old
                               // use blake2::{Blake2b512, Blake2s256, Digest};
                               // use blake2::{digest::consts::U10, digest::consts::U20, digest::consts::U32, Blake2b, Digest};
...
use chacha20poly1305::{
    // aead::{Aead, NewAead, Payload}, // old
    // aead::{Aead, AeadCore, KeyInit, OsRng}, // unuse
    aead::{Aead, KeyInit},
    ChaCha20Poly1305,
    Key,
    Nonce,
